...
@section('breadcrumb')
    @parent
    <li class="active">Arrangements</li>
@endsection
            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_perusahaan" class="col-lg-2 control-label">Name Arrangement</label>
                        <div class="col-lg-6">
                ...
                <div class="box-footer text-right">
                    <button class="btn btn-sm btn-flat btn-primary"><i class="fa fa-save"></i> Save Arrangement</button>
                </div>
            </form>
        </div>
    </div>
